...
oppia.controller('QuestionStateEditor', [
  '$scope', '$rootScope', 'EditorStateService', 'QuestionStatesService',
  ...
  function(
    ...
    $scope.initStateEditor = function() {
      ...
      var stateData = QuestionStatesService.getState(stateName);
      if (stateName && stateData) {
        ...
        var interactionId = QuestionStatesService.getInteractionIdMemento(
          stateName);
        ...
        var content = QuestionStatesService.getStateContentMemento(
          stateName);
  ...
  'UrlInterpolationService', function(UrlInterpolationService) {
    return {
      ...
      controller: [
        ...
        'EditorStateService', 'QuestionStatesService',
        ...
        'COMPONENT_NAME_FEEDBACK', function(
          ...
          var _state = QuestionStatesService.getState(_stateName);
