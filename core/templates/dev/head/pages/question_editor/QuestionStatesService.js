...
/**
 * @fileoverview Data service for keeping track of the question's states.
 * Note that this is unlike the other question property services, in that it
 * keeps no mementos.
 */

oppia.factory('QuestionStatesService', [
  '$log', '$uibModal', '$filter', '$location', '$rootScope', '$injector', '$q',
  'ExplorationInitStateNameService', 'AlertsService',
  'QuestionChangeListService',
  ...
  function(
      $log, $uibModal, $filter, $location, $rootScope, $injector, $q,
      ExplorationInitStateNameService, AlertsService, QuestionChangeListService,
      EditorStateService, ValidatorsService, StatesObjectFactory,
      SolutionValidityService, AngularNameService,
      AnswerClassificationService, ContextService,
      UrlInterpolationService) {
    ...
    var saveStateProperty = function(stateName, backendName, newValue) {
      ...
      if (!angular.equals(oldValue, newValue)) {
        QuestionChangeListService.editStateProperty(
    ...
    return {
      ...
      addState: function(newStateName, successCallback) {
        ...
        QuestionChangeListService.addState(newStateName);
      ...
      deleteState: function(deleteStateName) {
        ...
        return $uibModal.open({
          templateUrl: UrlInterpolationService.getDirectiveTemplateUrl(
            '/pages/question_editor/editor_tab/' +
          ...
          QuestionChangeListService.deleteState(deleteStateName);
      ...
      renameState: function(oldStateName, newStateName) {
        ...
        // exist.
        QuestionChangeListService.renameState(newStateName, oldStateName);
